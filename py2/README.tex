%%% -*- Mode: LaTeX; -*-
%       RCS: $Id: README.tex,v 1.1 2018-01-01 20:51:25 lsipusr Exp $
...
(Interactive Command Modules) Player. Takes an ICM as input and
allows for its command-line execution through a rich interactive
emacs inteface. Emacs dynamic interactions are implemented based
on org-mode dynamic blocks.
